 ...
 * @author zgm_e
 */
public class PrincipalOne extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Tiempos Ciclo");
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        Lineas o = new Lineas(new javax.swing.JDialog(), true);
        o.setVisible(true);
    }//GEN-LAST:event_jMenuItem4ActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        TiemposPromedio tc = new TiemposPromedio(new javax.swing.JDialog(), true);
        tc.setVisible(true);
    ...
    private void menuEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuEliminarActionPerformed
        ...
        if (tablaBitacora.getSelectedRow() >= 0) {
            reg.removeRow(tablaBitacora.getSelectedRow());
        } else {
            JOptionPane.showMessageDialog(this, "Selecciona registro", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_menuEliminarActionPerformed

    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        Operaciones op = new Operaciones(new javax.swing.JDialog(), true);
        op.setVisible(true);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (tablaBitacora.getRowCount() > 0) {
            ...
            if (Login.resp == 1) {
                Object[] datos;
                if (!cls.ExisteFechaBitacora(txtFecha.getText(), (DefaultTableModel) tablaBitacora.getModel()).isEmpty()) {
                    ArrayList h = cls.ExisteFechaBitacora(txtFecha.getText(), (DefaultTableModel) tablaBitacora.getModel());
...
//            java.util.logging.Logger.getLogger(PrincipalOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//    }
    ...
    public Object getCmbHora() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getTxtCantidadProducida() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getTxtTiempoInicio() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getTxtTiempoFin() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getTxtDuracion() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getCmbParteCambio() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getLblParteCambio() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getCmbOperacion() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getCmbArea() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getCmbProblema() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getCmbCliente() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Object getCmbNoParte() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
